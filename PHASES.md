...
2. **Generate the final demo APK list**: DIVA, InsecureShop, AndroGoat, plus 1–2 real Pakistani banking apps for the SBP demo
3. **Rehearse viva walkthrough** using the README's checklist
4. **Come back to this chat** for Chapters 4–7 of the FYP documentation (we deferred that earlier — it's now unblocked because all the code-doc alignment is automatic)

---

*This file is the execution roadmap. Any phase reordering, addition, or scope change requires explicit approval in the planning chat. Last updated: when this file was first written.*
